...
class UITableViewEdit: BaseVC,UITableViewDelegate {
    //刷新按钮
    ...
    override func viewDidLoad() {
        ...
        addButton = UIBarButtonItem.init(title: "新增", style: .plain, target: self, action: #selector(imageBarButtonItemMethod))
